...
return [
    ...
    'age'                   => "Age",
    'all_assets'			=> 'All Inventories',
    'all'       			=> 'All',
    'archived'              => 'Archived',
    'asset_models'			=> 'Inventory Models',
    'asset_model'			=> 'Inventory Model',
    'asset'					=> 'Inventory',
    'asset_report'          => 'Inventory Report',
    'asset_tag'				=> 'Inventory Tag',
    'asset_tags'            => 'Inventory Tags',
    'assets_available'		=> 'Inventories available',
    'accept_assets'         => 'Accept Inventories :name',
    'accept_assets_menu'    => 'Accept Inventories',
    'accept_item'           => 'Accept Item',
    'audit'				    => 'Audit',
    'audit_report'			=> 'Audit Log',
    'assets'				=> 'Inventories',
    'assets_audited'        => 'Inventories audited',
    'assets_checked_in_count'     => 'Inventories checked in',
    'assets_checked_out_count'     => 'Inventories checked out',
    ...
    'created_asset'			=> 'created Inventory',
    ...
    'custom_report'         => 'Custom Inventory Report',
    'dashboard'				=> 'Dashboard',
    ...
    'error'				    => 'Error',
    'exclude_archived'      => 'Exclude Archived Inventories',
    'exclude_deleted'       => 'Exclude Deleted Inventorys',
    'example'				=> 'Example: ',
    ...
    'include_deleted'       => 'Include Deleted Inventories',
    ...
    'importing'         	=> 'Importing',
    'importing_help'        => 'You can import Inventories, accessories, licenses, components, consumables, and users via CSV file. <br><br>The CSV should be comma-delimited and formatted with headers that match the ones in the <a href="https://snipe-it.readme.io/docs/importing" target="_new">sample CSVs in the documentation</a>.',
    'import-history'        => 'Import History',
    'asset_maintenance'        => 'Inventory Maintenance',
    'asset_maintenance_report' => 'Inventory Maintenance Report',
    'asset_maintenances'       => 'Inventory Maintenances',
    'item'  				=> 'Item',
    'item_name'             => 'Item Name',
    ...
    'location'              => 'Warehouse',
    'location_plural'        => 'Warehouse|Warehouses',
    'locations'				=> 'Warehouses / Office',
    'location_id'              => 'Warehouse ID',
    'location_name'            => 'Warehouse Name',
    'rtd_location'             => 'Default Warehouse',
    'current_location'         => 'Current Warehouse',
    'default_location'         => 'Default Warehouse',
    'assigned_location'        => 'Assigned Warehouse',
    'asset_location'           => 'Inventory Warehouse',
    'logo_size'				=> 'Square logos look best with Logo + Text. Logo maximum display size is 50px high x 500px wide.  ',
    'logout'				=> 'Logout',
    'lookup_by_tag'     => 'Lookup by Inventory Tag',
    ...
    'next_audit_date_help'  => 'If you use auditing in your organization, this is usually automatically calculated based on the Inventory&apos;s last audit date and audit frequency (in <code>Admin Settings &gt; Alerts</code>) and you can leave this blank. You can manually set this date here if you need to, but it must be later than the last audit date. ',
    'audit_images_help'     => 'You can find audit images in the Inventory\'s history tab.',
    ...
    'only_deleted'          => 'Only Deleted Inventorys',
    ...
    'requested_assets'      => 'Requested Inventorys',
    ...
    'unaccepted_asset_report' => 'Unaccepted Inventorys',
    'users'                 => 'Users',
    'viewall'				=> 'View All',
    'viewassets'  			=> 'View Assigned Inventories',
    'viewassetsfor'         => 'View Inventories for :name',
    'website'               => 'Website',
    ...
    'audit_due_days'        => '{}Inventories Due or Overdue for Audit|[1]Inventorys Due or Overdue for Audit Within a Day|[2,*]Inventorys Due or Overdue for Audit Within :days Days',
    'checkin_due'           => 'Due for Checkin',
    'checkin_overdue'       => 'Overdue for Checkin',
    'checkin_due_days'      => '{}Due for Checkin|[1]Inventorys Due for Checkin Within :days Day|[2,*]Inventorys Due for Checkin Within :days Days',
    ...
    'changed'               => 'Changed',
    'to'                    => 'To',
    'report_fields_info'    => '<p>Select the fields you would like to include in your custom report, and click Generate. The file (custom-Inventory-report-YYYY-mm-dd.csv) will download automatically, and you can open it in Excel.</p>
            <p>If you would like to export only certain Inventorys, use the options below to fine-tune your results.</p>',
    'range'                 => 'Range',
    ...
    'dashboard_empty'       => 'It looks like you have not added anything yet, so we do not have anything awesome to display. Get started by adding some Inventorys, accessories, consumables, or licenses now!',
    'new_asset'             => 'New Inventory',
    ...
    'asset_information'     => 'Inventory Information',
    'model_name'            => 'Model Name',
    'asset_name'            => 'Inventory Name',
    ...
    'checkin_to_diff_location' => 'You can choose to check this Inventory in to a location other than this Inventory\'s default location of :default_location if one is set',
    ...
    'shitty_browser'        => 'No signature detected. If you are using an older browser, please use a more modern browser to complete your Inventory acceptance.',
    'bulk_soft_delete'      =>'Also soft-delete these users. Their Inventory history will remain intact unless/until you purge deleted records in the Admin Settings.',
    ...
    'merge_information' =>  'This will merge the :count users into a single user. Select the user you wish to merge the others into below, and the associated Inventorys, licenses, etc will be moved over to the selected user and the other users will be marked as deleted.',
    ...
    'auto_incrementing_asset_tags_disabled_so_tags_required' => 'Generating auto-incrementing Inventory tags is disabled so all rows need to have the "Inventory Tag" column populated.',
    'auto_incrementing_asset_tags_enabled_so_now_assets_will_be_created' => 'Note: Generating auto-incrementing Inventory tags is enabled so Inventorys will be created for rows that do not have "Inventory Tag" populated. Rows that do have "Inventory Tag" populated will be updated with the provided information.',
    ...
    'error_user_company' => 'Checkout target company and Inventory company do not match',
    'error_user_company_accept_view' => 'An Inventory assigned to you belongs to a different company so you can\'t accept nor deny it, please check with your manager',
    'importer' => [
    ...
    'rtd_location_help' => 'This is the location of the Inventory when it is not checked out',
    ...
    'no_requestable' => 'There are no requestable Inventories or Inventory models.',

    'countable' => [
        'accessories'  => ':count Accessory|:count Accessories',
        'assets'  => ':count Inventory|:count Inventories',
    ...
    'more_info' => 'More Info',
    'quickscan_bulk_help' => 'Checking this box will edit the Inventory record to reflect this new location. Leaving it unchecked will simply note the location in the audit log. Note that if this Inventory is checked out, it will not change the location of the person, Inventory or location it is checked out to.',
    'whoops' => 'Whoops!',
    ...
    'label' => 'Label',
    'import_asset_tag_exists' => 'An Inventory with the Inventory tag :Inventory_tag already exists and an update was not requested. No change was made.',
...
// Add form placeholders here
    ...
    'deleted_models' => 'Deleted Inventory Models',
